...
const HeaderBar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex flex-col shrink-0 items-start mr-[76px] cursor-pointer" onClick={handleGoHome}>
        <img
          src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/N1bPFEGoXY/uwrmv9pm_expires_30_days.png"
          className="w-[105px] h-[66px] object-fill"
          alt="Logo"
        />
        <span className="text-[#3C315B] text-[25px] w-[116px] ml-[89px] whitespace-pre-line">
          {"SCORE\nPREDICT"}
        </span>
      </div>
